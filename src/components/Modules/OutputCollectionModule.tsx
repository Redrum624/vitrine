        ...
        <div className="flex items-center gap-3">
          ...
          {isExporting && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-green-300">{exportProgress.toFixed(0)}%</span>
            </div>
          )}
        </div>
        <div className="flex items-center gap-2">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-700 text-white text-sm rounded pl-10 pr-3 py-2 border border-gray-600 focus:border-green-400 focus:outline-none"
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <CategoryIcon className="w-4 h-4 text-green-400" />
                          <div>
                          ...
                          {selectedCollectionData.images.slice(0, 5).map(image => (
                            <div key={image.id} className="flex items-center justify-between text-xs">
                              ...
                              <span className={`px-1 rounded text-xs ${
                                image.status === 'completed' ? 'bg-green-900 text-green-200' :
                                image.status === 'error' ? 'bg-red-900 text-red-200' :
                                image.status === 'processing' ? 'bg-yellow-900 text-yellow-200' :
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-700 text-white text-sm rounded px-3 py-2 border border-gray-600 focus:border-green-400 focus:outline-none resize-none"
                  rows={2}
