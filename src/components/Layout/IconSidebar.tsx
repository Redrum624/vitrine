import { HardDrive, Settings, BarChart3, Sun, Droplet, Activity, Crop, Palette, Focus, Filter, History, Triangle } from 'lucide-react';
...
const tools: Tool[] = [
  ...
  { id: 'sharpen', icon: <Triangle className="w-5 h-5" />, name: 'Sharpen' },
